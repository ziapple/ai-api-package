      ...
      drag = function(event) {
        ...
        if (element.startEvent) {
          ...
          if (typeof constraint === 'function') {
			...
			if(constraint.x != null && element.startPosition.x == 0){
				element.startPosition.x = constraint.x;
			}
			if(constraint.y != null && element.startPosition.y == 0){
				element.startPosition.y = constraint.y;
		    }
            element.move(x, y);     
          }		  		  
          /* invoke any callbacks */
